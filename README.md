...
Current version: `v0.1.0-beta.7` · Beta software — read-only preview and export; it does not change your city. Back up saves before testing any mod.
...
当前版本：`v0.1.0-beta.7` · Beta 阶段软件 —— 只读预览和导出，不会改动你的城市。测试任何 mod 前请先备份存档。
