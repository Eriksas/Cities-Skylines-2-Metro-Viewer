...
Current version: `v0.1.0-alpha.2` · Alpha software — export only, it does not change your city. Back up saves before testing any mod.
...
当前版本：`v0.1.0-alpha.2` · Alpha 阶段软件 —— 只导出数据，不会改动你的城市。测试任何 mod 前请先备份存档。
